...
## This function generates random sample from the mixture logistic
...
## The log likelihood of each group, but why don't we sum it all up?
...
## The log-likelihood function, and possibly the first order derivative?
