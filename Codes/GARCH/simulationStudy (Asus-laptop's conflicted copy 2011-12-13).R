...
mysim <- mgarchSim(model = c(1e-3, 0.8, 0.1), 500,
...
mysim <- mgarchSim(model = c(1e-3, 0.8, 0.1), 800,
...
## bit sensitive, but the recoery is not too bad.
