...
\title{\bf Scale Normal Mixture GARCH: An Acccount for Back Swans}
...
\frame{
   ...
   \begin{align*}
     x_t &= \mu_t + \sigma_t \epsilon_t \;\;\;\;\;\;\;\;\;\;\;  
            \epsilon_t \sim N(0, 1)\\
     \sigma_t^2 &= \alpha_0 + \sum_{i = 1}^p \beta_i \sigma_{t-1}^2 +
      \sum_{j = 1}^q \alpha_i x_{t-1}^2\\
   \end{align*} 
   \end{block}
}
...
\frame{
    \frametitle{Estimation}
     The estimation is based on the semi-parametric mixture framework
     of Yong (2010).
